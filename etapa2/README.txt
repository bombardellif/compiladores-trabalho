...
Main.c fora do parser.y (Johann disse que isso não é obrigatório, mas preferível; vou deixar para o final, portanto [Obs.: ta dificil de entender as dependencias para extrair a main do parser.y])
